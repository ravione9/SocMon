...
export function formatContextForPrompt(context) {
  ...
  const lines = [
    ...
    '- For storeZabbix ping: latency = custom.ping.ms[8.8.8.8] (hosts[].ping.ms live, hosts[].latencyAtSession / latencyHistory for session windows). Jitter = custom.ping.jitter[8.8.8.8] (hosts[].ping.jitter live, hosts[].jitterAtSession / jitterHistory for session windows).',
