...
function generateRandomPassword() {
  const a = EASY_ADJECTIVES[secureRnd(EASY_ADJECTIVES.length)];
  const b = EASY_NOUNS[secureRnd(EASY_NOUNS.length)];
  const letters = `${a}${b}`;
  ...
  const sym = EASY_SPECIALS[secureRnd(EASY_SPECIALS.length)];
